...
void StreamHandleWrapper::buildHeadersFromTable(Http::HeaderMap& headers,
...
void Filter::EncoderCallbacks::respond(Http::ResponseHeaderMapPtr&&, Buffer::Instance*, lua_State* state) {
