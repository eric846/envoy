...
MockUpstream::MockUpstream(Upstream::MockClusterManager& mock_cm, const std::string& status,
  ...
  ON_CALL(mock_cm.async_client_, send_(testing::_, testing::_, testing::_))
      .WillByDefault(testing::Invoke(
          [this](Http::ResponseMessagePtr&, Http::AsyncClient::Callbacks& cb,
                 const Http::AsyncClient::RequestOptions&) -> Http::AsyncClient::Request* {
            Http::ResponseMessagePtr response_message(new Http::ResponseMessageImpl(
                Http::HeaderMapPtr{new Http::TestResponseHeaderMapImpl{{":status", status_}}}));
...
MockUpstream::MockUpstream(Upstream::MockClusterManager& mock_cm,
  ...
  ON_CALL(mock_cm.async_client_, send_(testing::_, testing::_, testing::_))
      .WillByDefault(testing::Invoke(
          [this, reason](Http::ResponseMessagePtr&, Http::AsyncClient::Callbacks& cb,
                         const Http::AsyncClient::RequestOptions&) -> Http::AsyncClient::Request* {
            cb.onFailure(reason);
            return &request_;
          }));
